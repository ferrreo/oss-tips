...
import { down, up } from './migrations/024_object_asset_legal_hold.js';
...
describe('object asset legal hold migration', () => {
  it('adds and removes the default-off legal hold state', async () => {
    ...
    expect(rolledBack.queries.join('\n')).toContain('DROP COLUMN IF EXISTS legal_hold');
