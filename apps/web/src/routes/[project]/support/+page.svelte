<script lang="ts">
  ...
  import ProjectSupportPage from '@oss-tips/ui/pages/public/ProjectSupportPage.svelte';
...
<SeoHead
  title={`${data.project.name}: ${t('public.support.choose', {}, $locale)}`}
  description={t('public.support.lead', {}, $locale)}
  canonical={canonicalUrl(page.url.origin, `/${data.project.slug}/support`)}
  noindex
/>
<ProjectSupportPage
  {...data}
